    ...
    protected virtual function void set_tx_fifo_full();
      fork
        begin
          ...
          `uvm_info("RX_FIFO", $sformatf("TX FIFO became full - %0s: %0d",
