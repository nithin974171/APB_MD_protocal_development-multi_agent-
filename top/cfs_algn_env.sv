...
`ifndef CFS_ALGN_ENV_SV
  ...
  class cfs_algn_env#(int unsigned ALGN_DATA_WIDTH = 32) extends uvm_env implements uvm_ext_reset_handler;
    ...
    virtual function void connect_phase(uvm_phase phase);
      ...
      virtual_sequencer.md_rx_sequencer = cfs_md_sequencer_base_master'(md_rx_agent.sequencer);//casting is used bez md_rx_agent is actualy declared in uvm_ext_class
      virtual_sequencer.md_tx_sequencer = cfs_md_sequencer_base_slave'(md_tx_agent.sequencer);//casting is used bez md_rx_agent is actualy declared in uvm_ext_class
